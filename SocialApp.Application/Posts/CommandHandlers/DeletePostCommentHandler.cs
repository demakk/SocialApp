...
public class DeletePostCommentHandler : IRequestHandler<DeletePostCommentCommand, OperationResult<PostComment>>
{
    private readonly DataContext _ctx;
    private readonly OperationResult<PostComment> _result;

    public DeletePostCommentHandler(DataContext ctx)
    {
        _ctx = ctx;
